...
public abstract class CPG2vec {
    ...
    protected String createNodeLabelsOnlyCPG_CONF1() {
        String toReturn = "node label";
        for (int i = 0; i < this.visitCPGid.size(); i++) {
            CPGNode tempNode = this.cpg.getCPGNodes().get(this.visitCPGid.get(i));
    ...
    protected String createNodeLabelsOnlyCPG_CONF2() {
        String toReturn = "node label";
        for (int i = 0; i < this.visitCPGid.size(); i++) {
            CPGNode tempNode = this.cpg.getCPGNodes().get(this.visitCPGid.get(i));
    ...
    protected String createNodeLabelsOnlyCPG_CONF3() {
        String toReturn = "node label";
        for (int i = 0; i < this.visitCPGid.size(); i++) {
            CPGNode tempNode = this.cpg.getCPGNodes().get(this.visitCPGid.get(i));
            toReturn = toReturn + "\n" + this.getNodeNumber(tempNode) + " " + mapNodeLabelFrequentToken3(tempNode.getAstNode());
        }
        return toReturn;
    }
    ...
    //Start Node 112
    //Continuos value: TFullIdentifier, TIdentifier, TAtIdentifier, TBoolConstant, TIntegerConstant, TFloatConstant, TStringConstant
    ...
    //Start Node 115
    //Continuos value: TBoolConstant, TIntegerConstant, TFloatConstant, TStringConstant
    //STMTs node and TNodes
    ...
    //Continuos value: TBoolConstant, TIntegerConstant, TFloatConstant, TStringConstant
    //All AST nodes
    private String mapNodeLabelFrequentToken3 (Node tempNode){
        if (tempNode == null) {//case ENTRY and EXIT Node
            return "0";
        } else if (tempNode instanceof EOF) {
            return "253";
